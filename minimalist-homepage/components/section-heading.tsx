...
export function SectionHeading({ title, subtitle }: SectionHeadingProps) {
  return (
    <div className="text-center space-y-4">
      ...
      >
        <div className="inline-block">
          <div className="relative px-3 py-1 text-sm font-medium rounded-full bg-white/10 backdrop-blur-sm border border-white/20 mb-2">
            ...
            <span className="absolute inset-0 rounded-full bg-gradient-to-r from-green-400/20 to-cyan-950/20 animate-pulse"></span>
          </div>
        </div>
      </motion.div>
      ...
      <motion.div
        className="w-24 h-1.5 bg-gradient-to-r from-green-400 to-cyan-950 rounded-full mx-auto mt-6"
